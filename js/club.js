const clubs = [
    ...
    { name: "Prompt", desc: "AI 융합전자공학과 동아리로, 인공지능, 머신러닝, 임베디드 시스템에 관심 있는 학술 동아리.", category: "학술/전공 연계" ,img:"assets/images/club/Prompt.jpg"},
    ...
    { name: "UNSA", desc: "유엔한국협회(UNA) 산하 단체로, 국내 최대 연합 동아리 단체.", category: "봉사/친목/대외활동",img:"assets/images/club/UNSA.jpg"},
    { name: "세종 로타랙트", desc: "국제 로타리클럽 산하 대학생 연합 봉사 동아리.", category: "봉사/친목/대외활동" ,img:"assets/images/club/SejongRotaract.jpg"},
    ...
    { name: "LIFRARY", desc: "생명과학과 관련된 여러 학술 활동과 정보 탐색 및 공유를 중점으로 하는 학술 동아리.", category: "학술/전공 연계" ,img:"assets/images/club/LIFrary.jpg"},
    ...
    { name: "별무리", desc: "교내유일 천문관측 중앙동아리.", category: "학술/전공 연계계" ,img:"assets/images/club/Byeolmuri.jpg"},
    { name: "STC", desc: "세종대 테니스 동아리.", category: "체육/레저" ,img:"assets/images/club/STC.jpg"},
    { name: "MESH", desc: "전공 학술 발표, 스터디, 진로 세미나 등을 진행하는 나노신소재공학부 학술동아리.", category: "학술/전공 연계" ,img:"assets/images/club/Mesh.jpg"},
    ...
    { name: "Foogle", desc: "식품 산업을 탐구하고 연구하는 식품생명공학전공 유일한 학술동아리.", category: "학술/전공 연계" ,img:"assets/images/club/Foogle.jpg"},
    ...
    { name: "아룸", desc: "기획, 디자인, 개발, 코딩테스트 준비 및 프로젝트를 중심으로 운영되는 학술 동아리.", category: "학술/전공 연계" ,img:"assets/images/club/Alom.jpg"},
    ...
    { name: "G:low", desc: "한국인, 외국인 학생들과 함께 한류에 대한 주제 탐구와 연구 및 문화 체험 활동을 하는 학술 동아리.", category: "공연/예술/문화" ,img:"assets/images/club/Glow.jpg"}
  ];
  clubs.sort((a, b) => {
